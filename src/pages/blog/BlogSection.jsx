...
export const BlogSection = () => {
  ...
  return (
<section className="mt-12 py-16 px-4 bg-gradient-to-br from-slate-50 min-h-screen">
    
    <div className=" min-h-screen py-2">
      <div className="max-w-7xl mx-auto ">
        {/* Header Section */}
        <div className="text-center mb-16">
          <div className="inline-block px-4 py-2 text-white text-base font-medium rounded mb-6" style={{
